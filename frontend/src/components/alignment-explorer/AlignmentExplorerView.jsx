...
export default function AlignmentExplorerView({theme='dark',config,genomes=[],incoming,onIncomingConsumed}) {
  ...
  const {tiles,annotations,connections,offWindow,counts,pending,warnings,displayCamera}=useLayerData(dataset,layer,renderState.camera,size,state.annotations,revision,setError)
